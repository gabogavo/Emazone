...
public class Brand {
    ...
    public Brand(Long id, String name, String description) {
        ...
        if (description.length() > DomainConstants.MAX_DESCRIPTION_LENGTH_BRAND) {
            throw new FieldTooLongException(DomainConstants.Field.DESCRIPTION.toString(), DomainConstants.MAX_DESCRIPTION_LENGTH_BRAND);
        }
